...
Forward-backwards training was used. Predictions were made by Viterbi algorithm. Because I limited the state space, the HMM was fast enough. %%%%GRAPHSSSSSS

\subsubsection*{Reinforcement Learning State}
%%%% second sweep
Q-learning was done with epsilon-greedy method. Different states were tried:
1. The previous note could be construed as a state from which actions were generated.
...
Hypothesis II not sustained for quantitative (accuracy measure on prediction), because there was not a significant difference between the accuracy or the average F1 of the models.
However, qualitative (which predictions they did make), were significantly different. Here, once can tell this by visual inspection of the confusion matrices of some of the models. To wit, the models got most things wrong, but it got those things wrong in different ways.
%%%conf mat pics here
